...
This guide walks you through creating and configuring a Slack app to send messages to the Harper Vector Memory System.

## Step 1: Create the Slack App

1. Go to [api.slack.com/apps](https://api.slack.com/apps)
2. Click **Create New App** > **From scratch**
3. Name it (e.g., "Harper Memory Bot") and select your workspace
4. Click **Create App**
